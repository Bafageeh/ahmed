...
Route::post('/ta3meed/investments/{id}/receipts', [Ta3meedMutationController::class, 'storeReceipt']);
Route::post('/ta3meed/receipts/parse', [Ta3meedMutationController::class, 'parseReceipt']);
Route::post('/ta3meed/receipts/apply-message', [Ta3meedMutationController::class, 'applyReceiptMessage']);
