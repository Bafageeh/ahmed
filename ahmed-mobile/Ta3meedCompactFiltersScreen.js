...
const styles = StyleSheet.create({
  ...
  metricGrid: { marginTop: 12, flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8 },
  metricCard: { flexBasis: '48%', flexGrow: 1, backgroundColor: '#fff', borderRadius: 18, padding: 12, borderWidth: 1, borderColor: '#e2e8f0', alignItems: 'flex-end' },
