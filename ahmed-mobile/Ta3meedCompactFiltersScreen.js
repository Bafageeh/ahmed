...
const styles = StyleSheet.create({
  ...
  metricGrid: { marginTop: 8, flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 6 },
  metricCard: { flexBasis: '48%', flexGrow: 1, backgroundColor: '#fff', borderRadius: 14, padding: 8, borderWidth: 1, borderColor: '#e2e8f0', alignItems: 'flex-end' },
  metricWide: { flexBasis: '100%' },
  metricTitle: { color: '#64748b', fontSize: 12, fontWeight: '900', textAlign: 'right' },
  metricValue: { marginTop: 4, color: '#0f172a', fontSize: 15, fontWeight: '900', textAlign: 'right' },
  ...
  card: { backgroundColor: '#fff', borderRadius: 24, borderWidth: 1.5, padding: 14, marginBottom: 14 },
  cardTop: { flexDirection: 'row-reverse', alignItems: 'center', gap: 5 },
  cardTitleBlock: { flex: 1, alignItems: 'flex-end' },
  cardCode: { color: '#111827', fontSize: 25, fontWeight: '900', textAlign: 'right' },
  cardMeta: { marginTop: 6, color: '#64748b', fontSize: 13, fontWeight: '900', textAlign: 'right' },
  ...
  rateBadgesRow: { marginTop: 10, flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 7, justifyContent: 'flex-start' },
  rateBadge: { backgroundColor: '#eef2ff', color: '#4338ca', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, overflow: 'hidden', fontSize: 12, fontWeight: '900' },
  actualRateBadge: { backgroundColor: '#dcfce7', color: '#166534' },
  amounts: { marginTop: 16, flexDirection: 'row-reverse', gap: 8 },
  mini: { flex: 1, backgroundColor: '#f8fafc', borderRadius: 18, padding: 12, alignItems: 'flex-end' },
  miniLabel: { color: '#64748b', fontWeight: '900', fontSize: 12 },
  miniValue: { marginTop: 7, color: '#0f172a', fontWeight: '900', fontSize: 17, textAlign: 'right' },
  progressBox: { marginTop: 16, backgroundColor: '#f8fafc', borderRadius: 18, padding: 12 },
  progressHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  progressPercent: { color: '#0f766e', fontWeight: '900', fontSize: 18 },
  progressTitle: { color: '#0f172a', fontWeight: '900', fontSize: 16 },
  ...
  progressMeta: { marginTop: 9, color: '#64748b', fontWeight: '900', textAlign: 'right' },
  ...
  detailsButton: { marginTop: 14, backgroundColor: '#dcfce7', borderRadius: 18, paddingVertical: 14, alignItems: 'center' },
  detailsButtonText: { color: '#0f766e', fontSize: 16, fontWeight: '900' },
