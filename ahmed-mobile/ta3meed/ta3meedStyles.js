...
export const styles = StyleSheet.create({
  ...
  itemIconWrap: { width: 50, alignItems: 'flex-end', justifyContent: 'center' },
  itemIcon: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center', shadowColor: '#111827', shadowOpacity: 0.16, shadowRadius: 7, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
  itemIconText: { color: '#fff', fontSize: 18, fontWeight: '900' },
  ...
  expandedArea: { marginTop: 12, backgroundColor: '#f8fafc', borderRadius: 16, borderWidth: 1, borderColor: '#e2e8f0', padding: 12 },
