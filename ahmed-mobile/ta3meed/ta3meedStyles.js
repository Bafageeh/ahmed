...
export const styles = StyleSheet.create({
  ...
  investorRateText: { marginTop: 7, color: '#0f766e', fontSize: 11.5, fontWeight: '900', textAlign: 'right', lineHeight: 18 },
  ...
  cardActionSymbol: { fontSize: 18, fontWeight: '900', lineHeight: 22, textAlign: 'center' },
  cardActionDelete: { color: '#dc2626' },
  cardActionCheck: { color: '#047857' },
  cardActionEdit: { color: '#0f8bdc' },
  cardActionEye: { color: '#1f2937' },
  ...
  investorAccountButton: { marginTop: 11, minHeight: 54, borderRadius: 18, backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#dbe4ea', paddingHorizontal: 14, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between' },
  investorAccountButtonText: { color: '#0f172a', fontSize: 15, fontWeight: '900', textAlign: 'right' },
  investorAccountButtonIcon: { color: '#0f766e', fontSize: 26, fontWeight: '900' },
  investorAccountBackButton: { alignSelf: 'flex-end', backgroundColor: '#ecfdf5', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7, marginBottom: 10 },
  investorAccountBackText: { color: '#0f766e', fontSize: 12, fontWeight: '900' },
  investorBalanceText: { marginTop: 10, color: '#0f766e', fontSize: 19, fontWeight: '900', textAlign: 'right' },
  ...
  investorNotesInput: { minHeight: 104, textAlignVertical: 'top' },
  investorEntryTypeRow: { marginTop: 10, flexDirection: 'row-reverse', gap: 8 },
  investorEntryTypeButton: { flex: 1, borderRadius: 14, borderWidth: 1, borderColor: '#dbe4ea', backgroundColor: '#fff', paddingVertical: 10, alignItems: 'center' },
  investorEntryTypeButtonActive: { backgroundColor: '#0f766e', borderColor: '#0f766e' },
  investorEntryTypeButtonDanger: { backgroundColor: '#dc2626', borderColor: '#dc2626' },
  investorEntryTypeText: { color: '#334155', fontSize: 13, fontWeight: '900' },
  investorEntryTypeTextActive: { color: '#fff' },
  investorPaymentButton: { marginTop: 9, backgroundColor: '#0f766e', borderRadius: 14, paddingVertical: 11, alignItems: 'center' },
  investorWithdrawButton: { backgroundColor: '#dc2626' },
  investorCancelEditButton: { marginTop: 8, backgroundColor: '#fff', borderWidth: 1, borderColor: '#dbe4ea', borderRadius: 14, paddingVertical: 10, alignItems: 'center' },
  investorCancelEditText: { color: '#334155', fontSize: 13, fontWeight: '900' },
  investorWithdrawText: { color: '#dc2626' },
  ...
  balanceEntryHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  balanceEntryActions: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  balanceEntryActionButton: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#fff', borderWidth: 1, borderColor: '#e2e8f0', alignItems: 'center', justifyContent: 'center' },
  balanceEntryActionIcon: { fontSize: 17, fontWeight: '900', lineHeight: 21 },
  balanceEntryEditIcon: { color: '#0f8bdc' },
  balanceEntryDeleteIcon: { color: '#dc2626' },
